...
// user_settings.agendaHub; TrackLastView grava o pathname vivo
// ("/operacao/agenda") p/ o RestoreLastView da Home (whitelist literal em
// validateLastView, que migra o valor legado "/agenda" na leitura).
// v1.1 (05/08/2026): movida de /agenda p/ /operacao/agenda — card padrão de
// Operação no hub (saiu do nav lateral; /agenda virou stub de redirect).
