...
-- DESFAZ a Fase 12 (mock de "Data Reunião" + congelamento). Este é o "código
-- SQL que desfaz" citado na especificação — é o ÚNICO caminho para:
