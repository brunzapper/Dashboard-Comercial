...
-- BLOCO ÚNICO — FASE 6A — colar no SQL Editor do Supabase APÓS a Fase 3.
-- Estende o motor de widgets (run_widget_query) p/ o construtor de dashboards.
-- Idempotente (create or replace).
-- ============================================================================

-- >>>>>>>>>>>>>>>>>>>> migrations/0015_widget_rpc_extend.sql <<<<<<<<<<<<<<<<<<<<
-- Versão: 1.0 | Data: 05/07/2026
