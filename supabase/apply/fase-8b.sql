...
-- BLOCO ÚNICO — FASE 8b — colar no SQL Editor do Supabase APÓS a Fase 8.
-- Rótulos visuais autoritativos + visibilidade dos campos do Bitrix. Idempotente.
-- ============================================================================

-- >>>>>>>>>>>>>>>>>>>> migrations/0022_field_label_overrides.sql <<<<<<<<<<<<<<<<<<<<
-- Versão: 1.0 | Data: 09/07/2026
