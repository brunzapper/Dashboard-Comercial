...
-- BLOCO ÚNICO — FASE 6B — colar no SQL Editor do Supabase APÓS a Fase 6A.
-- Metas (goals), operações aninhadas, widgets.settings, operation_subtree.
-- Idempotente.
-- ============================================================================

-- >>>>>>>>>>>>>>>>>>>> migrations/0016_metas_operacoes.sql <<<<<<<<<<<<<<<<<<<<
-- Versão: 1.0 | Data: 05/07/2026
