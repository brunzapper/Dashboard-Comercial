...
// (mesma receita visual das abas de Registros). Os painéis chegam prontos do
...
type TabKey = "campos" | "correspondencias" | "conexoes" | "moedas";
...
const TAB_ORDER: TabKey[] = ["campos", "correspondencias", "conexoes", "moedas"];
...
export function CamposTabs({
  ...
  const tabs = TAB_ORDER.filter((key) => key !== "moedas" || moedas != null);
